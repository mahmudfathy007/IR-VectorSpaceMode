...
def data():
    ...
    maximum=0
#Checking the relevency of the letter in the files
    for i in range(1,11):
        file=open('files/d%i'%i,'r')
        l=file.readline()
        ...
        arrA.append(a/maximum)
        arrB.append(b/maximum)
        arrC.append(c/maximum)
        arrD.append(d/maximum)
        arrE.append(e/maximum)
        arrF.append(f/maximum)
    ...
    return render_template("Calculations.html", data=sorted_dic)
